...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lastname' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['roles_id'], 'references' => ['roles', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'roles_id' => 1,
                'is_active' => 1,
                'created' => '2025-01-14 18:43:07',
                'modified' => '2025-01-14 18:43:07',
            ],
        ];
        parent::init();
    }
